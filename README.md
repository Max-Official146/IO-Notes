...
- Offline mode entry when Firebase is not configured.
...
If these values are missing or invalid, use **Continue offline** in the auth screen and the app will save notes locally.
